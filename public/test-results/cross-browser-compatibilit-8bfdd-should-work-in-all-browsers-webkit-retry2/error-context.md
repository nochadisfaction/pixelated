...
Error: expect.toBeVisible: Error: strict mode violation: locator('header') resolved to 2 elements:
    ...
    2) <header class="mb-8" data-astro-source-loc="313:32" data-astro-source-file="/home/runner/work/gradiant/gradiant/src/layouts/DocumentationLayout.astro">…</header> aka getByText('Documentation Welcome to the Gradiant Documentation', { exact: true })
