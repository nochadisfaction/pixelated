...
function getProjectUrls() {
  ...
  return {
    ...
    upstash: upstashUrl.replace('https://', '').split('/')[0], // Remove path if present
  }
}
...
export const cspConfig: CSPConfig = {
  ...
  'connect-src': [
    ...
    ...(function () {
      ...
      return [`https://${urls.supabase}`, `https://${urls.upstash}`]
    })(),
  ...
  'font-src': [
    ...
    'https://cdn.jsdelivr.net',
    'https://pixelated-jk5qsc8v0-blackmage.vercel.app',
    'data:',
  ],
