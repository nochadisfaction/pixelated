...
describe('Data Validation', () => {
  describe('validateParticipantDemographics', () => {
    ...
    it('should throw error for invalid gender', () => {
      ...
      expect(() => validateParticipantDemographics(invalidDemographics))
    ...
    it('should throw error for missing required fields', () => {
      ...
      expect(() => validateParticipantDemographics(incompleteDemographics))
        .toThrow('Invalid participant demographics data');
    });
  });
  ...
  describe('validateTherapeuticSession', () => {
    ...
    it('should throw error for invalid session ID', () => {
      ...
      expect(() => validateTherapeuticSession(invalidSession))
        .toThrow('Invalid therapeutic session data');
    });
  });
  ...
  describe('validateBiasDetectionConfig', () => {
    ...
    it('should throw error for invalid threshold order', () => {
      ...
      expect(() => validateBiasDetectionConfig(invalidConfig))
        .toThrow('Invalid bias detection configuration');
    });
...
describe('Demographic Processing', () => {
  ...
  describe('extractDemographicGroups', () => {
    it('should extract all demographic groups', () => {
      ...
      expect(groups.find(g => g.type === 'socioeconomic')?.value).toBe('middle');
...
describe('Bias Score Calculations', () => {
  ...
  describe('calculateFairnessMetrics', () => {
    ...
    it('should throw error for insufficient groups', () => {
      ...
      expect(() => calculateFairnessMetrics(singleGroup))
        .toThrow('At least two demographic groups required');
    });
  });
});
...
describe('Error Handling', () => {
  ...
  describe('handleBiasDetectionError', () => {
    ...
    it('should handle unknown errors', () => {
      ...
      const result = handleBiasDetectionError(unknownError, { operation: 'test' });
...
describe('HIPAA Compliance', () => {
  ...
  describe('requiresAdditionalAuth', () => {
    it('should require auth for high sensitivity data', () => {
      ...
      expect(requiresAdditionalAuth('session-data', 'admin', 'critical')).toBe(true);
    });
    ...
    it('should require auth for session data for viewers', () => {
      ...
      expect(requiresAdditionalAuth('session-data', 'analyst', 'low')).toBe(false);
    });
  });
...
describe('Utility Helpers', () => {
  ...
  describe('retryWithBackoff', () => {
    ...
    it('should throw after max retries', async () => {
      ...
      await expect(retryWithBackoff(operation, 2, 10))
