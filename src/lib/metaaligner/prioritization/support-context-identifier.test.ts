...
describe('SupportContextIdentifier', () => {
  ...
  describe('Pattern-Based Support Recognition', () => {
    it('should identify emotional validation requests', async () => {
      const query = "I feel so terrible about this situation and just need someone to understand";
    ...
    it('should identify coping assistance requests', async () => {
      const query = "I don't know how to handle this stress at work, what should I do?";
      const result = await identifier.identifySupportContext(query);
    ...
    it('should identify active listening requests', async () => {
      const query = "I just need someone to listen to me right now, no advice needed";
      const result = await identifier.identifySupportContext(query);
    ...
    it('should identify practical guidance requests', async () => {
      const query = "What steps should I take to deal with my relationship problems?";
      const result = await identifier.identifySupportContext(query);
    ...
    it('should identify grief support needs', async () => {
      const query = "I'm grieving the loss of my father and don't know how to cope";
      const result = await identifier.identifySupportContext(query);
  ...
  describe('Emotional State Detection', () => {
    it('should detect sadness indicators', async () => {
      const query = "I feel so sad and heartbroken about everything that happened";
      const result = await identifier.identifySupportContext(query);
    ...
    it('should detect overwhelm indicators', async () => {
      const query = "I'm completely overwhelmed and can't handle anything anymore";
      const result = await identifier.identifySupportContext(query);
  ...
  describe('AI-Powered Analysis', () => {
    ...
    it('should include conversation history in AI analysis', async () => {
      ...
      const history = ["Previous message about depression", "Another context message"];
  ...
  describe('Support Recommendations', () => {
    it('should generate appropriate recommendations for emotional validation', async () => {
      const mockResult: SupportContextResult = {
        ...
        urgency: 'medium',
        supportNeeds: [SupportNeed.VALIDATION, SupportNeed.EMOTIONAL_REGULATION],
      ...
      const recommendations = identifier.generateSupportRecommendations(mockResult);
    ...
    it('should generate crisis-appropriate recommendations for high urgency', async () => {
      const mockResult: SupportContextResult = {
        ...
        urgency: 'high',
        supportNeeds: [SupportNeed.SAFETY_PLANNING, SupportNeed.HOPE_RESTORATION],
    ...
    it('should provide practical guidance recommendations', async () => {
      const mockResult: SupportContextResult = {
        ...
        urgency: 'medium',
        supportNeeds: [SupportNeed.PRACTICAL_ADVICE, SupportNeed.SKILL_BUILDING],
  ...
  describe('Urgency Assessment', () => {
    it('should classify high urgency for crisis indicators', async () => {
      const query = "I'm completely overwhelmed and breaking point, can't handle anything";
      const result = await identifier.identifySupportContext(query);
  ...
  describe('Coping Capacity Assessment', () => {
    it('should identify low coping capacity', async () => {
      const query = "I can't cope anymore, everything is too much, I'm falling apart";
      const result = await identifier.identifySupportContext(query);
  ...
  describe('Integration and Edge Cases', () => {
    ...
    it('should handle mixed emotional states', async () => {
      const query = "I'm feeling sad but also angry and confused about everything";
      const result = await identifier.identifySupportContext(query);
