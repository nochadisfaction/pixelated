    ...
    const mockDashboardData: BiasDashboardData = {
      ...
      demographics: {
        ...
        breakdown: [
          ...
          { group: 'Non-binary', count: 87, percentage: 7.0, averageBiasScore: 0.28 },
          { group: 'Prefer not to say', count: 39, percentage: 3.1, averageBiasScore: 0.22 }
        ],
        ageGroups: [
      ...
      recentSessions: [
        {
          ...
          biasScore: 0.15,
          alertLevel: 'low',
          participantDemographics: { gender: 'female', age: '28', ethnicity: 'white' },
        ...
        },
        {
          ...
          biasScore: 0.67,
          alertLevel: 'high',
          participantDemographics: { gender: 'male', age: '34', ethnicity: 'hispanic' },
...
function generateTrendData(timeRange: string, metric: 'bias_score' | 'alerts') {
  ...
  for (let i = points - 1; i >= 0; i--) {
    const timestamp = new Date(now.getTime() - (i * getTimeRangeMs(timeRange) / points));
...
function generateDemographicTrends(timeRange: string) {
  return {
    ...
    ethnicityTrends: [
      { demographic: 'White', trend: 'stable', change: 0.00 },
      { demographic: 'Hispanic/Latino', trend: 'concerning', change: 0.06 },
      { demographic: 'Black/African American', trend: 'improving', change: -0.02 },
