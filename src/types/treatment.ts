...
export type TreatmentPlanStatus = 'Draft' | 'Active' | 'Completed' | 'Discontinued' | 'Archived';
export type TreatmentGoalStatus = 'Not Started' | 'In Progress' | 'Achieved' | 'Partially Achieved' | 'Not Achieved';
export type TreatmentObjectiveStatus = 'Not Started' | 'In Progress' | 'Completed' | 'On Hold' | 'Cancelled';
